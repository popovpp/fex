...
class ViewSetTests(TestCase):
    ...
    def test_POST_of_anonimous_create_new_user(self):
        response = requests.post(self.uri_users, data={"email":"v1@sas.com", 
                                 "password":"1"})
        self.assertEqual(response.status_code, 201)
        response = requests.post(self.uri_auth, data={"username":"v1@sas.com", 
                                 "password":"1"})
        token = response.json()['token']
        response = requests.get(self.uri_users, 
                                headers={'Authorization': 'token {}'.format(token)})
        uri_user = response.json()[0]['url']
        response = requests.delete(uri_user, 
                                   headers={'Authorization':'token {}'.format(token)})
    ...
    def test_POST_get_authorization_token(self):
        response = requests.post(self.uri_users, data={"email":"v2@sas.com", 
                                 "password":"1"})
        response = requests.post(self.uri_auth, data={"username":"v2@sas.com", 
                                 "password":"1"})
    ...
    def test_GET_authorized_user(self):
        response = requests.post(self.uri_users, data={"email":"v3@sas.com", 
                                 "password":"1"})
        response = requests.post(self.uri_auth, data={"username":"v3@sas.com", 
                                 "password":"1"})
        token = response.json()['token']
        response = requests.get(self.uri_users, 
                                headers={'Authorization': 'token {}'.format(token)})
    ...
    def test_POST_authorized_user_create_new_user(self):
        response = requests.post(self.uri_users, data={"email":"v4@sas.com", 
                                 "password":"1"})
        response = requests.post(self.uri_auth, data={"username":"v4@sas.com", 
                                 "password":"1"})
        token = response.json()['token']
        response = requests.post(self.uri_users, 
                                 headers={'Authorization': 'token {}'.format(token)}, 
                                 data={"email":"v4_1@sas.com", "password":"1"})
        self.assertEqual(response.status_code, 201)
        response = requests.post(self.uri_auth, data={"username":"v4_1@sas.com", 
                                 "password":"1"})
        token = response.json()['token']
        response = requests.get(self.uri_users, 
                                headers={'Authorization': 'token {}'.format(token)})
    ...
    def test_PUT_authorized_user(self):
        response = requests.post(self.uri_users, data={"email":"v5@sas.com", 
                                 "password":"1"})
        response = requests.post(self.uri_auth, data={"username":"v5@sas.com", 
                                 "password":"1"})
        token = response.json()['token']
        response = requests.get(self.uri_users, 
                                headers={'Authorization': 'token {}'.format(token)})
        uri_user = response.json()[0]['url']
        response = requests.put(uri_user, 
                                headers={'Authorization':'token {}'.format(token)}, 
                                data={"email":"v5@sas.com", "password":"1", 
                                "first_name":"Boris"})
        self.assertEqual(response.status_code, 200)
        response = requests.post(self.uri_auth, data={"username":"v5@sas.com", 
                                 "password":"1"})
    ...
    def test_PATCH_authorized_user(self):
        response = requests.post(self.uri_users, data={"email":"v6@sas.com", 
                                 "password":"1"})
        response = requests.post(self.uri_auth, data={"username":"v6@sas.com", 
                                 "password":"1"})
        token = response.json()['token']
        response = requests.get(self.uri_users, 
                                headers={'Authorization': 'token {}'.format(token)})
        uri_user = response.json()[0]['url']
        response = requests.patch(uri_user, 
                                  headers={'Authorization':'token {}'.format(token)}, 
                                  data={"email":"v6@sas.com", "password":"1", 
                                  "last_name":"Jhonson"})
        self.assertEqual(response.status_code, 200)
        response = requests.post(self.uri_auth, data={"username":"v6@sas.com", 
                                 "password":"1"})
    ...
    def test_DELETE_authorized_user_delete_someself(self):
        response = requests.post(self.uri_users, data={"email":"v7@sas.com", 
                                 "password":"1"})
        response = requests.post(self.uri_auth, data={"username":"v7@sas.com", 
                                 "password":"1"})
        token = response.json()['token']
        response = requests.get(self.uri_users, 
                                headers={'Authorization': 'token {}'.format(token)})
    ...
    def test_DELETE_superuser_delete_of_any_user(self):
        response = requests.post(self.uri_users, data={"email":"v8@sas.com", 
                                 "password":"1"})
        response = requests.post(self.uri_auth, data={"username":"test@test.com", 
    ...
    def test_PUT_superuser_put_of_any_user(self):
        response = requests.post(self.uri_users, data={"email":"v9@sas.com", 
                                 "password":"1"})
        response = requests.post(self.uri_auth, data={"username":"test@test.com", 
                                 "password":"password123"})
        token = response.json()['token']
        ...
        response = requests.put(uri_user, 
                                headers={'Authorization':'token {}'.format(token)}, 
                                data={"email":"v9@sas.com", "password":"1", 
                                "first_name":"Djohn"})
        self.assertEqual(response.status_code, 200)
        response = requests.delete(uri_user, 
                                   headers={'Authorization':'token {}'.format(token)})
    ...
    def test_PATCH_superuser_patch_of_any_user(self):
        response = requests.post(self.uri_users, data={"email":"v10@sas.com", 
                                 "password":"1"})
        response = requests.post(self.uri_auth, data={"username":"test@test.com", 
                                 "password":"password123"})
        token = response.json()['token']
        ...
        response = requests.patch(uri_user, 
                                  headers={'Authorization':'token {}'.format(token)}, 
                                  data={"email":"v10@sas.com", "password":"1", 
                                  "last_name":"Broun"})
        self.assertEqual(response.status_code, 200)
        response = requests.delete(uri_user, 
                                   headers={'Authorization':'token {}'.format(token)})
    ...
    def test_GET_superuser_full_info(self):
        response = requests.post(self.uri_users, data={"email":"v11@sas.com", 
                                 "password":"1"})
        response = requests.post(self.uri_auth, data={"username":"test@test.com", 
                                 "password":"password123"})
        token = response.json()['token']
    ...
    def test_GET_authorized_user_get_only_self_info(self):
        response = requests.post(self.uri_users, data={"email":"v12@sas.com", 
                                 "password":"1"})
        response = requests.post(self.uri_auth, data={"username":"v12@sas.com", 
                                 "password":"1"})
        token = response.json()['token']
        response = requests.get(self.uri_users, 
                                headers={'Authorization': 'token {}'.format(token)})
...
class AppsTests(TestCase):
    ...
    def test_there_are_apps(self):
        self.assertEqual('account' not in [app for app in settings.INSTALLED_APPS 
                         if not "django" in app], False)
...
class UserModelTests(TestCase):
    ...
    def test_help_text_of_is_superuser_field(self):
        ...
        self.assertEquals(field_param, 'Designates that this user ' + 
    ...
    def test_help_text_of_is_staff_field(self):
        ...
        self.assertEquals(field_param,'Designates whether the user can ' + 
    ...
    def test_help_text_of_is_active_field(self):
        ...
        self.assertEquals(field_param, 'Designates whether this user ' + 
    ...
    def test_help_text_of_groups_field(self):
        ...
        self.assertEquals(field_param, 'The groups this user ' +
...
class UserSerializerTests(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.uri_users = 'http://' + cls.IP + ':8000' + '/users/'
        cls.uri_auth = 'http://' + cls.IP + ':8000' + '/api-token-auth/'
        response = requests.post(cls.uri_users, data={"email":"v13@sas.com",
                                 "password":"1"})
        response = requests.post(cls.uri_auth, data={"username":"v13@sas.com",
                                 "password":"1"})
        cls.token = response.json()['token']
        response = requests.get(cls.uri_users, 
                                headers={'Authorization': 'token {}'.format(cls.token)})
        cls.uri_user = response.json()[0]['url']

    @classmethod
    def tearDownClass(cls):
        response = requests.delete(cls.uri_user, 
                                   headers={'Authorization':'token {}'.format(cls.token)})


    def test_put_authorized_user_change_readonly_groups(self):
        response = requests.put(self.uri_user, 
                                headers={'Authorization':'token {}'.format(self.token)}, 
                                data={"email":"v13@sas.com", "password":"1",
                                "groups":'sellers', "first_name":"Jim"})
    ...
    def test_put_authorized_user_change_readonly_freeze_balance(self):
        response = requests.put(self.uri_user, 
                                headers={'Authorization':'token {}'.format(self.token)}, 
                                data={"email":"v13@sas.com", "password":"1", 
                                "freeze_balance":100, "first_name":"Jim"})
        self.assertEqual(response.status_code, 403)
    ...
    def test_put_authorized_user_change_readonly_is_active(self):
        response = requests.put(self.uri_user, 
                                headers={'Authorization':'token {}'.format(self.token)}, 
                                data={"email":"v13@sas.com", "password":"1", 
                                "is_active":False, "first_name":"Jim"})
        self.assertEqual(response.status_code, 403)
    ...
    def test_put_authorized_user_change_readonly_date_joined(self):
        response = requests.put(self.uri_user, 
                                headers={'Authorization':'token {}'.format(self.token)}, 
                                data={"email":"v13@sas.com", "password":"1", 
                                "date_joined":'21.12.20', "first_name":"Jim"})
        self.assertEqual(response.status_code, 403)
    ...
    def test_put_authorized_user_change_readonly_last_login(self):
        response = requests.put(self.uri_user, 
                                headers={'Authorization':'token {}'.format(self.token)}, 
                                data={"email":"v13@sas.com", "password":"1", 
                                "last_login":'21.12.20', "first_name":"Jim"})
        self.assertEqual(response.status_code, 403)

    def test_patch_authorized_user_change_readonly_groups(self):
        response = requests.patch(self.uri_user, 
                                  headers={'Authorization':'token {}'.format(self.token)}, 
                                  data={"email":"v13@sas.com", "password":"1", 
                                  "groups":'sellers', "first_name":"Jim"})
        self.assertEqual(response.status_code, 403)
